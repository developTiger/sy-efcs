...
public class EquipmentDto {
     ...
     */
    @MemberIgnore
    private Collection<EquipmentExtensionDto> EquipmentExtension;
    ...
    public Collection<EquipmentExtensionDto> getEquipmentExtension() {
        return EquipmentExtension;
    }

    public void setEquipmentExtension(Collection<EquipmentExtensionDto> equipmentExtension) {
        EquipmentExtension = equipmentExtension;
    }
    ...
    public void setChannelEvent(HashMap<Integer, String> channelEvent) {
