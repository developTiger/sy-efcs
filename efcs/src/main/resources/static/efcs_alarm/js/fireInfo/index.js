...
define(function (require, exports, module) {
    var EasyPage = require('easypage'),
        Enums = require("enums"),
        dataUrl = appPath + '/efcs_alarm/fireInfo/grid';
            ...
            colModel: [
                ...
                },
                {
                    ...
                    formatter: function (cellvalue, options, rowObject) {
                        return '<a class="btn btn-link btn-xs" target="_blank"' +
                            '   href="' + appPath + '/efcs_alarm/fireInfo/detail_view?id=' + rowObject.id + '">详情</a>';
                    }
                }
            ],
