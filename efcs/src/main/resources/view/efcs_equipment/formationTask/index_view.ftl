...
<div class="page-search">
    <form class="form-inline" id="Js_search_form" method="post" action="../core/equipment/grid" >
        <div class="form-group">
            <label class="control-label"><@message>拉线</@message>：</label>
            <input type="text" class="form-control" name="equip_name">
        </div>
        <div class="form-group">
            <label class="control-label"><@message>任务类型</@message>：</label>
            <select class="form-control" name="equip_type">

            </select>
        </div>
        <div class="form-group">
            <label class="control-label"><@message>计划类型</@message>：</label>
            <select class="form-control" name="equip_type">

            </select>
        </div>
        <div class="form-group">
            <label class="control-label"><@message>状态</@message>：</label>
...
<div class="page-wrapper">
    <div class="page-buttons">
        <button type="button" class="btn btn-info Js_task_add">
            创建工装任务
        </button>
    </div>
